...
{		
	if (Tcl_CreateObjCommand( interp, "r_kernels", custom_r_kernels, NULL, NULL) == NULL) 
    {
        return TCL_ERROR;
    }
	if (Tcl_CreateObjCommand( interp, "alg_division", custom_alg_division, NULL, NULL) == NULL) 
    {
        return TCL_ERROR;
    }
	if (Tcl_CreateObjCommand( interp, "graph_critical_path", custom_graph_critical_path, NULL, NULL) == NULL) 
    {
        return TCL_ERROR;
    }
	if (Tcl_CreateObjCommand( interp, "write_graph", custom_write_graph, NULL, NULL) == NULL) 
    {
        return TCL_ERROR;
    }
	if (Tcl_CreateObjCommand( interp, "draw_graph", custom_draw_graph, NULL, NULL) == NULL) 
    {
        return TCL_ERROR;
    }

	if (Tcl_CreateObjCommand( interp, "read_graph", custom_read_graph, NULL, NULL) == NULL) 
    {
        return TCL_ERROR;
    }
